...
function Team() {
  const teamMembers = [
    ...
    },
    {
      id: 2,
      image: "/team/king.JPG",
      name: "Kingdavid Christian",
      role: "Full Stack Developer",
      handle: "@KingShowPlays",
      experience: "3+ years",
      specialties: ["Nextjs", "TailwindCSS", "MongoDB"],
      borderColor: "border-emerald-500",
      gradientFrom: "from-emerald-500",
      gradientTo: "to-teal-600",
      social: {
        github: "https://github.com/KingShowPlays",
        linkedin: "https://linkedin.com/in/KingShowPlays",
      },
    },
    {
      id: 3,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 space-y-6">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            cutting-edge technology, creative design, and strategic innovation.
          </p>
            ...
            >
              <CardContent className="p-0">
                ...
                <div className="relative overflow-hidden h-96">
                  ...
                  {/* Gradient Overlay */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-t ${member.gradientFrom} ${member.gradientTo} opacity-0 group-hover:opacity-80 transition-opacity duration-500`}
                  />
        ...
        <div className="text-center">
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Each team member brings unique expertise and passion to every
            project. Hover over the profiles above to learn more about our
